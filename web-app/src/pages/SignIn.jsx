   ...
   <div className="flex items-center">
      <div className="flex p-3 w-screen max-w-[80%] mx-auto flex-col md:flex-row md:items-center gap-10 m-[-90px]">
        ...
        <form className="flex flex-col gap-4" onSubmit={login}>
          ...
          <h1 class="text-5xl">Prisijungimas</h1>
          <p class="text-[1.4rem] text-[#a8aebb]  hover:text-blue-600 mb-2">Prisijunkite, su savo Office 365 duomenimis.</p>
            <div>
            ...
            <button
              type="submit"
              disabled={loading}
              class="bg-blue-500 hover:bg-blue-00 text-white font-bold py-1 px-24 border-b-4 border-blue-700 hover:border-blue-500 rounded buttonas"
            >
              {loading ? (
                <>
                  <Spinner size="sm" />
        ...
        <div className="flex-2 bg-sky-300">
         <img src={kitm} class="object-fill" alt="" />
